...
with open('../../Data/Proteins_of_Interest/Secondary_Structure_Files/' + task_name + '.txt', 'r') as file:
...
for j in range(len(protein_of_interest_ids)):
    ...
    positive_sequences = load_sequences('../../Data/Secondary_Structure_Files/' + task_name + '.txt')
    negative_sequences = load_sequences('../../Data/Secondary_Structure_Files/non' + task_name + '.txt')
